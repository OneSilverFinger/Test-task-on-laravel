...
<?php $__env->startSection('title', 'Создать поставщика'); ?>
...
<div class="card">
    ...
    <form action="<?php echo e(route('suppliers.store')); ?>" method="POST">
        ...
        <div style="display: flex; gap: 1rem;">
            ...
            <a href="<?php echo e(route('suppliers.index')); ?>" class="btn">Отмена</a>
        </div>
    </form>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/suppliers/create.blade.php ENDPATH**/ ?>