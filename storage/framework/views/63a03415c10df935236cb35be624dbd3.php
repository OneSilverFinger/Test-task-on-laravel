...
<?php $__env->startSection('title', 'Создать продажу'); ?>

<?php $__env->startSection('content'); ?>
<div class="card">
    <div class="card-header">Создать продажу</div>
    
    <form action="<?php echo e(route('sale-orders.store')); ?>" method="POST" id="orderForm">
        <?php echo csrf_field(); ?>
        ...
        <div style="display: flex; gap: 1rem; margin-top: 2rem;">
            ...
            <a href="<?php echo e(route('sale-orders.index')); ?>" class="btn">Отмена</a>
        </div>
    </form>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/sale-orders/create.blade.php ENDPATH**/ ?>